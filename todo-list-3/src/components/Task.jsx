  ...
  return (
    <div className="flex items-center justify-between max-w-xl text-white mt-2 ">
      <div className="flex items-center">
        {completed ? (
          <span className="mx-4 border border-gray-800 rounded-full bg-green-500 p-2 m-2 cursor-pointer"></span>
        ) : (
          <span className="mx-4 border border-gray-800 rounded-full bg-gray-500 p-2 m-2 cursor-pointer"></span>
        )}
